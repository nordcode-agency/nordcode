...
<div id="top" role="document">
    ...
    <div>
        <section id="colors" class="stack">
            ...
            <h2>Borders</h2>
            <div class="cluster">
                <div class="box" style="border: var(--border-width-base) solid var(--color-border-strong)">
                    <small>color-border-strong</small>
                </div>
                <div class="box" style="border: var(--border-width-base) solid var(--color-border-base)">
                    <small>color-border-base</small>
                </div>
                <div class="box" style="border: var(--border-width-base) solid var(--color-border-subtle)">
      ...
                    <p><em>This text has added emphasis. But, it should not be displayed in a comment</em></p>-->
        ...
        <section>
            ...
            <fieldset class="stack">
                ...
                <div class="layout-container" style="border: var(--border-width-base) solid var(--color-border-base)">
            ...
            <fieldset class="stack">
                ...
                <div
                        class="stack"
                        style="border: var(--border-width-base) solid var(--color-border-base)"
                >
                    <p>element 1</p>
                    <p>element 2</p>
                    <p>element 3</p>

        ...
        <section id="colors" class="stack">
            ...
            <div class="stack -layout-none">
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-brand-primary-strong)"></div>
                    <small>color-brand-primary-strong</small>
                </div>
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-brand-primary-base)"></div>
                    <small>color-brand-primary-base</small>
                </div>
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-brand-primary-subtle)"></div>
                    <small>color-brand-primary-subtle</small>
                </div>

                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-brand-secondary-strong)"></div>
                    <small>color-brand-secondary-strong</small>
                </div>
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-brand-secondary-base)"></div>
                    <small>color-brand-secondary-base</small>
                </div>
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-brand-secondary-subtle)"></div>
                    <small>color-brand-secondary-subtle</small>
                </div>

                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-text-strong)"></div>
                    <small>color-text-strong</small>
                </div>
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-text-base)"></div>
                    <small>color-text-base</small>
                </div>
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-text-subtle)"></div>
                    <small>color-text-subtle</small>
                </div>

                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-surface-strong)"></div>
                    <small>color-surface-strong</small>
                </div>
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-surface-base)"></div>
                    <small>color-surface-base</small>
                </div>
                <div style="display: grid; align-items: center; gap: var(--spacing-near); grid-template-columns: auto 1fr;">
                    <div style="inline-size: 100px; block-size: 50px; box-shadow: 0 0 0 1px #000; background-color: var(--color-surface-subtle)"></div>
            ...
            <h2>Borders</h2>
            <div class="cluster">
                <div class="box" style="border: var(--border-width-normal) solid var(--color-border-strong)">
                    <small>color-border-strong</small>
                </div>
                <div class="box" style="border: var(--border-width-normal) solid var(--color-border-base)">
                    <small>color-border-base</small>
                </div>
                <div class="box" style="border: var(--border-width-normal) solid var(--color-border-subtle)">
      ...
                    <p><em>This text has added emphasis. But, it should not be displayed in a comment</em></p>-->
        ...
        <section>
            ...
            <fieldset class="stack">
                ...
                <div class="layout-container" style="border: var(--border-width-normal) solid var(--color-border-base)">
            ...
            <fieldset class="stack">
                ...
                <div
                        class="stack"
                        style="border: var(--border-width-normal) solid var(--color-border-base)"
                >
                    <p>element 1</p>
                    <p>element 2</p>
                    <p>element 3</p>
            ...
            <fieldset class="stack">
                ...
                <p class="note">
                    ...
                    elements, that I removed in the reset, because I prefer it that
                    way
                </p>
                <div
                        class="flow"

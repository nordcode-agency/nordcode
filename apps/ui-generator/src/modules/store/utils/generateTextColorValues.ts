...
export const generateLightTextColorValues = (
    ...
    return {
        ...
        [`--color-${tokenName}-on-emphasis-${themeSuffix}`]: `oklch(var(--lightness-max) var(${cTokenName}) var(${hTokenName}))`,
...
export const generateDarkTextColorValues = (
    ...
    return {
        ...
        [scaleTokenName]: `${colorDef.scalingFactor}`,
        [`--color-${tokenName}-base-${themeSuffix}`]: `oklch(var(${lTokenName}) var(${cTokenName}) var(${hTokenName}))`,
        [`--color-${tokenName}-muted-${themeSuffix}`]: `oklch(calc(var(${lTokenName}) * var(${scaleTokenName})) calc(var(${cTokenName}) * var(${scaleTokenName})) var(${hTokenName}))`,
        [`--color-${tokenName}-subtle-${themeSuffix}`]: `oklch(calc(var(${lTokenName}) * var(${scaleTokenName}) * var(${scaleTokenName})) calc(var(${cTokenName}) * var(${scaleTokenName}) * var(${scaleTokenName})) var(${hTokenName}))`,

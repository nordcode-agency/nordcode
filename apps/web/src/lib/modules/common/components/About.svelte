        ...
        <div class="nc-ram-grid grid">
            ...
            <div class="content">
                <div class="nc-flow prose">
                    ...
                    <p>
                        Hi, wir sind <strong>Lukas</strong> und <strong>Joshua</strong>, zwei Frontend-Entwickler mit
                        zusammen <strong>über 15 Jahren Erfahrung</strong>.
                    </p>
                    <p>
                        Wir leben irgendwo im Norden von Deutschland und sind leidenschaftliche Webentwickler mit
                        verschiedenen Stärken und Schwächen und großer Lust, coole Projekte zu bauen.
                    </p>
                    <p>
                        Unser Fokus liegt auf <strong>Web, das funktioniert</strong>. Barrierefrei, schnell und sicher
                        muss es immer sein. Ein bisschen Freude soll es machen. Alles andere entscheidet das Projekt.
                    </p>
                </div>
            </div>
        </div>

...
.oval-wrapper {
    --size: calc(60px + var(--shadow-blur) * var(--shadow-max-multiplier) + var(--shadow-vertical-offset) * -1);
...
.oval {
    ...
    box-shadow:
        0px var(--shadow-vertical-offset) calc(var(--shadow-blur) * var(--shadow-max-multiplier) / 8) 0px
        rgba(255, 255, 255, 0.7),
        0px var(--shadow-vertical-offset) calc(var(--shadow-blur) * var(--shadow-max-multiplier) / 4) 0px
        rgba(255, 255, 255, 0.5),
        0px var(--shadow-vertical-offset) calc(var(--shadow-blur) * var(--shadow-max-multiplier) / 2) 0px
        var(--color-brand-secondary-emphasis-dark),
        0px var(--shadow-vertical-offset) calc(var(--shadow-blur) * var(--shadow-max-multiplier)) 0px

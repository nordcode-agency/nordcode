	...
	<div class="footer nc-box nc-center">
		<div class="misc nc-stack -farthest">
			...
			<div class="nc-stack -near">
				<a href={ensureTrailingSlash(Navigation.impressum.url)}
					>{Navigation.impressum.name}</a
				>
		...
		<div class="nc-stack -far">
			...
			<div class="nc-stack contact-item">
				...
				<a class="gradient-text contact-links" href="https://wa.me/message/6D6KQFSIQQ6EG1"
					>Whatsapp</a
				>
			</div>
			...
			<div class="nc-stack contact-item">
				...
				<a class="gradient-text contact-links" href="tel:+4915563134234"
					>+49 155 63 134 234</a
				>
			</div>
		</div>
